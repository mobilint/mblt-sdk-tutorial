...
def generate_calibration(
    ...
    print(f"Loading KorSTS dataset...")
    try:
        dataset = load_dataset("mteb/KorSTS", split="valid")["sentence1"]
...
def main():
    ...
    parser.add_argument("--tokenizer_path", type=str, default="jhgan/ko-sbert-sts")
