...
이 예제에서는 Ultralytics의 [YOLO11m-obb](https://docs.ultralytics.com/tasks/obb/) 모델을 사용합니다. 이 모델은 DOTA 스타일 항공 영상에서의 회전 객체 탐지를 위해 학습되었으므로, 이 튜토리얼도 캘리브레이션에 DOTA 데이터셋을 사용하고 `1024x1024` letterbox 전처리를 적용합니다.
