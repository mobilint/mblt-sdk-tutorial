...
This tutorial explains how to compile an object detection model with Mobilint `qbcompiler`.
...
The example uses the following quantization settings:
...
After the command finishes, the corresponding MXQ and MBLT files are saved in the current directory.
