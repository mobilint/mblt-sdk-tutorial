...
이 튜토리얼은 Mobilint `qbcompiler`를 사용해 포즈 추정 모델을 컴파일하는 방법을 설명합니다.

예제에서는 Ultralytics가 COCO 데이터셋으로 사전 학습한 [YOLO11m-pose](https://docs.ultralytics.com/models/yolo11/) 모델을 사용합니다. 이 모델은 이미지 안의 객체에 대해 골격 키포인트를 추정합니다.
