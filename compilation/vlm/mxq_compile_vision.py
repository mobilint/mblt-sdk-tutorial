"""Compile the Qwen3-VL vision transformer MBLT to MXQ (encoder, benchmark-best 2B config).
...
# derived from the decoder MXQ save basename (Qwen3-VL-2B-Instruct_text_model).
ROTATION_MATRIX_PATH = "./spinWeight/Qwen3-VL-2B-Instruct_text_model/R1/global_rotation.pth"
...
if __name__ == "__main__":
    ...
    mblt_path = "mblt/Qwen3-VL-2B-Instruct_vision_transformer.mblt"
    save_path = "mxq/Qwen3-VL-2B-Instruct_vision_transformer.mxq"
