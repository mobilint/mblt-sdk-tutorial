    ...
    for sg in md.subgraphs:
        for op in sg.operators:
            ...
            if op.layertype == LayerType.MatMul:
                ...
                _right = sg.activations[op.options.inputs[1]]  # Value matrix
...
def compile_language_model(
    ...
    print("   ✓ Marked attention_mask[-1] as dynamic")
    print("   ✓ Marked position_ids[-1] as dynamic")
    print("   ✓ Marked inputs_embeds[1] as dynamic")
    print("   ✓ Marked cache_position[0] as dynamic")
    print("   ✓ Set attention_mask type: causal_mask")
    ...
    print("   ✓ Applied CachedQwen2VLRotaryEmbedding (pre-cached RoPE)")
    print("   ✓ Applied PatchedQwen2VLSdpaAttention (last-query slicing)")
    print("   ✓ Applied PatchedQwen2VLDecoderLayer (final layer optimization)")
    print("   ✓ Pre-computed RoPE for max_seq_len=16384")
    ...
    print("   ✓ FX graph tracing complete")
    ...
    print("   ✓ Set dynamic shapes for Q, K, V matrices")
