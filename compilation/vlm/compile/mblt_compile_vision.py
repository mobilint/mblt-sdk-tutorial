...
def compile_vision_encoder(
    ...
    with InputCaptureCtxManager(model.visual, max_call_limit, inputs_container) as _:
    ...
    print("   ✓ Applied PatchedPatchEmbed (3D→2D conv)")
    print("   ✓ Applied PatchedVisionSdpaAttention (split QKV)")
    print("   ✓ Applied PatchedPatchMerger")
