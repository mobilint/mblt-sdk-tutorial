...
if __name__ == "__main__":
    parser = ArgumentParser(description="Compile YOLO Face ONNX model to MXQ model (Regulus)")
    parser.add_argument(
        "--onnx-path",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Target NPU. Face only ships a YOLOv12 weight, which requires regulus2; regulus is unsupported here.",
    )
