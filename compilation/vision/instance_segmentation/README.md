...
In this tutorial, we will use the [YOLO11m-seg](https://docs.ultralytics.com/models/yolo11/) model, an instance segmentation model developed by Ultralytics.
...
fter the calibration dataset and the model are prepared, we can compile the model.
