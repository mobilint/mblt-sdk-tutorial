...
```bash
yolo export model=yolov8m-seg.pt format=onnx # Export YOLOv8m-seg model to ONNX format
```
...
After executing the above command, the compiled model will be saved as `yolov8m-seg.mxq` in the current directory.
