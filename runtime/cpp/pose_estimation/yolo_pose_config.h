...
// (3 strides x [reg_max*4 box + nc cls + num_keypoints*3 kpt] channels), so one config covers both ARIES and REGULUS
// MXQ files. Not applicable to P6 variants (num_layers=4).
#pragma once
#include "types.h"
