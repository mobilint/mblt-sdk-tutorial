...
int main(int argc, char** argv) {
    ...
    if (input_type == "float") {
        // !uint8 MXQ: /255 normalization is not fused. transform_float emits an HWC /255 float
        // buffer (same layout as the working uint8 path), wrapped in a non-owning NDArray view.
