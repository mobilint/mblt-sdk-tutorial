...
int main(int argc, char** argv) {
    ...
    model_config.setSingleCoreMode(
        {mobilint::CoreId{mobilint::Cluster::Cluster0, mobilint::Core::Core0}});
    ...
    try {
        ...
        const int input_height =
            static_cast<int>(channel_last ? input_shape[0] : input_shape[1]);
        const int input_width =
            static_cast<int>(channel_last ? input_shape[1] : input_shape[2]);
        ...
        cv::Mat depth = postprocess_depth(
