...
This guide is a continuation of [mblt-sdk-tutorial/compilation/vision/instance_segmentation/README.md](file:///workspace/mblt-sdk-tutorial/compilation/vision/instance_segmentation/README.md). It is assumed that you have successfully compiled the model and have the following file ready:
...
```bash
python inference_mxq.py --model-path ../../../compilation/vision/instance_segmentation/yolo11m-seg.mxq --image-path ../rc/cr7.jpg --output-path tmp/cr7.jpg --conf-thres 0.25 --iou-thres 0.45
```
...
The script prints detection results (labels and confidence scores) to the console and saves an image with drawn bounding boxes and masks to `tmp/cr7.jpg`.
