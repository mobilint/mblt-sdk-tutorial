...
import numpy as np
import qbruntime
from postprocess import YoloSegPostProcessAnchorless
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model-path",
        type=str,
        default="../../compilation/instance_segmentation/yolo11m-seg.mxq",
    ...
    postprocess = YoloSegPostProcessAnchorless(args.conf_thres, args.iou_thres)
