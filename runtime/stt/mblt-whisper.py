...
class MobilintWhisperEncoder(MobilintWhisperPreTrainedModel):
    def __init__(self, config: MobilintWhisperConfig):
        ...
        self.mxq_model = qbruntime.Model(f"{config.name_or_path}/{config.encoder_mxq_path}", mc)
    ...
    def forward(
        ...
        return BaseModelOutput(last_hidden_state=hidden_states, hidden_states=None, attentions=None)
...
class MobilintWhisperDecoder(MobilintWhisperPreTrainedModel):
    ...
    def __init__(self, config: MobilintWhisperConfig):
        ...
        self.mxq_model = qbruntime.Model(f"{config.name_or_path}/{config.decoder_mxq_path}", mc)
        print("Model Initialized")
        print(
